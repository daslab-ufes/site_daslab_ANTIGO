Utilizando mapas para mostrar estatísticas
================
Bruno Santos
...
```
    ...
    ## $ `Densidade demográfica - hab/km² [2010]`                              <dbl> …
...
![](mapas_da_estatistica_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](mapas_da_estatistica_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->
